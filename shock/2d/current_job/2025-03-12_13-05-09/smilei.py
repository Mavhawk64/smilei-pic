...
simulation_time = travel_time + num_shocks * injection_duration  # Total simulation time
...
DiagTrackParticles(
    species="electrons",
    attributes=["px", "py"],
    every=simulation_time // 2,
)

# Track particle positions and momenta for ions
DiagTrackParticles(species="ions", attributes=["px", "py"], every=simulation_time // 2)
